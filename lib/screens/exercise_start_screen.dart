...
class _ExerciseStartScreenState extends State<ExerciseStartScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor:  const Color(0xff192a56), title: const Text('FITNESS DHH'),centerTitle: true,),
              ...
              CachedNetworkImage(
                      ...
                      Container(
                        ...
                        child: SleekCircularSlider(
                          appearance: const CircularSliderAppearance(animationEnabled: true)
                          ,
                          initialValue: 30,
                          max: 60,
                          min: 2,
                          ...
                          innerWidget: (v){
                           ...
                           return Center(
                             child: Text("${v.toInt()} Sec", style: const TextStyle(
                        ...
                        Container(
                          ...
                          child: ClipRRect(
                            ...
                            child: Container(
                              ...
                              style: ElevatedButton.styleFrom(primary: const Color(0xff5B54FA), ),

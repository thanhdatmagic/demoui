...
class _HomePageState extends State<HomePage> {
  ...
  // get data from Json
  Uri apiURL = Uri.parse('https://raw.githubusercontent.com/codeifitech/fitness-app/master/exercises.json');
  var decodedjson;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor:  const Color(0xff192a56), title: const Text('FITESS DHH'),centerTitle: true,),
                    ...
                    ClipRRect(
                      ...
                      child: Container(
                        ...
                        decoration: const BoxDecoration(
                          gradient: LinearGradient(colors: [Color(0xFF000000),Color(0x00000000) ],
